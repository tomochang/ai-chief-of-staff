...
[UPSIDER](https://up-sider.com)（法人カードスタートアップ、[みずほフィナンシャルグループ](https://www.mizuhogroup.com/)が買収）の副社長をしています。取締役会、投資家コール、1日5件以上の外部ミーティング — メール、Slack、LINE、Messengerを横断して、何も漏らさない仕組みが必要でした。2026年1月から毎日使っています。
